    ...
    return (
        <>
            <div className="text-center px-4 pt-16 pb-10 sm:px-2 lg:px-8 lg:pt-24 lg:pb-10">
                <h2 className="text-3xl font-bold tracking-tight text-morado_abalat sm:text-4xl uppercase">Fechas de "{tourName}"</h2>
            </div>
            {
                events.length !== 0 ?
                <div className='p-8'>
                                ...
                                {events.map((event) => (
                                    <tr key={event.id}>
                                        ...
                                        <td className="relative py-4 pl-3 pr-6 text-right text-sm font-medium md:pr-4">
                                            <Link to={'/invitados/'+event.id} className="text-highlight hover:text-lowContrast">
                                            Ver fechas<span className="sr-only">, {event.name}</span>
                                            </Link>
                                        </td>
                                    </tr>
                                ))}
